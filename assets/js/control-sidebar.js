(function($, AdminLTE) {
    ...
    var tab_button = $("<li />", { "class": "active" })
        .html("<a href='#control-sidebar-theme-demo-options-tab' data-toggle='tab'>" + "<i class='mdi mdi-wrench'></i>" + "</a>");
    ...
    demo_settings.append(
        ...
        //Sidebar Toggle
        + "<div class='form-group'>" + "<input type='checkbox' data-layout='sidebar-collapse' id='sidebar-collapse' class='pull-right'/><label for='sidebar-collapse' class='control-sidebar-subheading'>" + "Toggle Sidebar" + "</label>" + "<p>Toggle the left sidebar's state (open or collapse)</p>" + "</div>"
        //Control Sidebar Toggle
        + "<div class='form-group'>" + "<input type='checkbox' data-controlsidebar='control-sidebar-open' id='control-sidebar-open' class='pull-right'/><label for='control-sidebar-open' class='control-sidebar-subheading'>" + "Toggle Right Sidebar Slide" + "</label>" + "<p>Toggle between slide over content and push content effects</p>" + "</div>"
        //Control Sidebar Skin Toggle
        + "<div class='form-group'>" + "<input type='checkbox' data-sidebarskin='toggle' id='toggle' class='pull-right'/><label for='toggle' class='control-sidebar-subheading'>" + "Toggle Right Sidebar Skin" + "</label>" + "<p>Toggle between dark and light skins for the right sidebar</p>" + "</div>"
    );
